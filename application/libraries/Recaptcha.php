...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_invisible_siteKey = $this->_ci->config->item('recaptcha_invisible_site_key');
        $this->_invisible_secretKey = $this->_ci->config->item('recaptcha_invisible_secret_key');
        $this->_language = $this->_ci->config->item('recaptcha_lang');

        if (empty($this->_siteKey) or empty($this->_secretKey) or empty($this->_invisible_secretKey) or empty($this->_invisible_siteKey)) {
    ...
    public function getInvisibleWidget(array $parameters = array())
    {
        $default = array(
            'data-sitekey' => $this->_invisible_siteKey,
